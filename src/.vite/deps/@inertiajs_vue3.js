...
var S2 = ref(null);
var A2 = null;
var J2 = defineComponent({ name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: (e) => e }, onHeadUpdate: { type: Function, required: false, default: () => () => {
...
var X2 = defineComponent({ props: { title: { type: String, required: false } }, data() {
  ...
  return this.addTitleElement(e.flatMap((o) => o.type.toString().startsWith("Symbol") && o.children ? o.children : o).map((o) => this.renderTag(o)).filter((o) => o));
} }, render() {
